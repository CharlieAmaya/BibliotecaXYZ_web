<%-- Document : editar Created on : 28/10/2024, 8:01:35 p. m. Author : amaya
--%> <%@page import="Logica.Estudiante"%> <%@page contentType="text/html"
pageEncoding="UTF-8"%>
<!DOCTYPE html>
<html>
  <head>
    ...
    <title>Edicion de Estudiante</title>
    <script
  ...
  <body>
    ...
    <% Estudiante estu = (Estudiante)
    request.getSession().getAttribute("estuEditar"); %>
